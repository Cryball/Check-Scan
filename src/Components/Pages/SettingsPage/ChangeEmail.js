    ...
    const onChangeEmailPress = () => {
        reauthenticate(currentPassword).then(() => {
            ...
            user.updateEmail(newEmail).then(() => {
                Alert.alert("Электронная почта изменена");
            ...
            <View>
                <View style={{
                    ...
                    <View style={{ width: '80%', alignItems: 'center' }}>
                        <Text style={{ color: 'white', fontSize: 24, fontWeight: '700' }}>Смена электронной почты</Text>
                    </View>
                </View>
                <View style={{ padding: 10 }}>
                    ...
                    <TextInput style={styles.textInput} value={newEmail}
                        placeholder="Новая электронная почта" autoCapitalize="none"
                        placeholderTextColor='#FFFBFB'
                    ...
                    <View style={{ alignItems: 'center' }}>
                        <TouchableOpacity
                            ...
                            style={styles.button}
                        >
                            <Text style={styles.buttonText}>Сменить электронную почту</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
